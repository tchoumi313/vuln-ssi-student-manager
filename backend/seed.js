...
await User.insertMany([
  ...
  { username: 'prof.dupont', password: await hash('dupont2024'),  role: 'enseignant' },
  { username: 'catherine',   password: await hash('cath2024'),    role: 'etudiant', studentId: students[0]._id },
  { username: 'ulrich',      password: await hash('ulrich2024'),  role: 'etudiant', studentId: students[1]._id },
  { username: 'donald',      password: await hash('donald2024'),  role: 'etudiant', studentId: students[2]._id },
]);
